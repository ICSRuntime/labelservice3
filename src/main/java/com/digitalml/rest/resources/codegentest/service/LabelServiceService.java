...
public abstract class LabelServiceService {

	private static final Logger LOGGER = LoggerFactory.getLogger(LabelServiceService.class);
	...
	static {
		URL configFile = LabelServiceService.class.getResource("LabelServiceServiceMappings.xml");
		if (configFile != null) {
